"""
Django settings for LSDtest1 project.
...
#SECRET_KEY = 'django-insecure-l-bv0-ty@p0gwkg4ew*30yg=onvv)p06hud8er%)r3ea&lz1c4' heroku
...
CELERY_BROKER_URL = os.environ.get('REDIS_TLS_URL', 'rediss://default')
CELERY_RESULT_BACKEND = os.environ.get('REDIS_TLS_URL', 'rediss://default')
...
#internal IP is from youtube video
INTERNAL_IPS = [
    # ...
    "127.0.0.1",
    # ...
...
# Jordan's Key
# SECRET_KEY = 'django-insecure-l-bv0-ty@p0gwkg4ew*30yg=onvv)p06hud8er%)r3ea&lz1c4'

# Rory's Key
SECRET_KEY = 'django-insecure-=29vpdntnl)-(zdv6)8c=ly3cv169b2xb^vv3@#i04otuk5iwc'
